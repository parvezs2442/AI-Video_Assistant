...
# #converting the audio into proper format from mp4 , mp3 to wav
...
# Extract/download audio from any video using link/url
...
# Convert any audio/video file into proper WAV format
def convert_to_wav(input_path: str) -> str:
...
# Automating audio processing based on user input
def process_input(source: str) -> list:
